...
public class Main {
    ...
    mas[2]=' ';
    mas[3]='3';
           int count=0,l=mas.length-1;
        for(int i = mas.length-1; i>=0; i--)
        {
                 if(mas[i]==' ')
                     count++;
        }
        int n = mas.length-count*2-1;
         while (n>0)
         {
             if(mas[n]==' ')
             {
    ...
    private static void workWithMatrix() {
        ...
        System.out.println(deepToString(mas1));
        sum=0;
        for(int i=0; i<mas1.length;i++)
        {
        ...
        System.out.println(deepToString(mas2));
    }
    ...
    private static void sumDiagonal() {
        ...
        for(int i=0; i<mas.length;i++)
        {
         ...
         System.out.println(deepToString(mas));
        int sum=0;
        for(int i=0;i<mas.length;i++)
        {
         sum+=mas[i][i];
